...
def test_settings_accepts_thermal_model_manifest_path_alias():
    settings = Settings(
        _env_file=None,
        THERMAL_MODEL_MANIFEST_PATH="/models/thermal/model-manifest.thermal.stage10b.yaml",
    )

    assert settings.thermalModelManifestPath == "/models/thermal/model-manifest.thermal.stage10b.yaml"
